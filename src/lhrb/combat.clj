...
;; DRAFT
;;
;; just some experiments to write a combat simulation
;; currently combat is not a part of the game anymore
;;
;; the implementation can not handle large armees atm
;; --------------------------------------------------
